					...
					<div>
						...
						<div style ={{marginLeft: "50px"}}>
							...
							<p>
								...
								explore the field of computer science, and transition into a new career. In addition to studying computer
								science at the University of Florida, Vincente has been fortunate enough to have the opportunity to work
								as a Technical Assistant with Info Tech in Gainesville, FL, gaining experience using Python to build custom
								forms for Department of Transportation clients, as well as working with the Customer Support team during an
								internship in the Spring of 2020 and will be working with the ITI Products Front End development team in an
								upcoming Spring of 2021 internship.
							</p>
